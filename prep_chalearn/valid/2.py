...
video_store = "/home/axp798/axp798gallinahome/ConGD/ConGD_phase_1/valid/"
json_store = "/home/axp798/axp798gallinahome/store/valid/json/"
labels_path = '/home/axp798/axp798gallinahome/ConGD/ConGD_phase_2/valid.txt'
store_frames_path = "/home/axp798/axp798gallinahome/store/valid/frames/"
...
def saveFramesWithLabels(video_store, json_store, labels_path):
    ...
    save_video_path = '/home/axp798/axp798gallinahome/data/chalearn/valid_64/'
    save_bounding_box_path = "/home/axp798/axp798gallinahome/data/chalearn/valid_boxes/"
    ...
    for curr_line in lines[start: ]:
        ...
        for j, curr_label in enumerate(label_info):
            ...
            with open(save_bounding_box_path + "{}_{}.pkl".format(start + 1, 4200), 'wb') as f:
