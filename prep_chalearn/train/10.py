...
def saveFramesWithLabels(video_store, json_store, labels_path):
    ...
    log_file_path = "/home/axp798/axp798gallinahome/Gesture-Detection/assets/chalearn_dataset/log10.txt"
    ...
    for curr_line in lines[start : ]:
        ...
        for j, curr_label in enumerate(label_info):
            ...
            with open(save_bounding_box_path + "{}_{}.pkl".format(start + 1, 14350), 'wb') as f:
