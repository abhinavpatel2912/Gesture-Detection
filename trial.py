...
videos_frames_path = "/home/axp798/axp798gallinahome/store/train/frames/"
...
for curr_line in lines:
    ...
    for curr_label in label_info:
        ...
        if not os.path.exists(dir_path) or not os.path.exists(vid_path):
            skipped_videos.append("{}-{}".format(par_name, vid_name))
            print("skipped {}-{}".format(par_name, vid_name))
            continue
        ...
        curr_dict = {}
        curr_video_path = os.path.join(videos_frames_path, dir_info)
        ...
        print("video_dir: {}".format(curr_video_path))
        print("range_of_frames: {}".format([start, end]))
        print("label: {}".format(label))
        print("bounding box: {}".format(bounding_box))

        data.append(curr_dict)

        print("Done {} videos".format(num_videos))
        if num_videos >= 15000:
            break
    ...
    print("skipped videos: {}".format(skipped_videos))
