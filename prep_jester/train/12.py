...
def saveFramesWithLabels(video_store, json_store, train_lables_path, labels_path):
    ...
    log_file_path = "/home/axp798/axp798gallinahome/Gesture-Detection/assets/jes_dat/log12.txt"
    ...
    for videoName_and_label in list_train_videos_name[start : ]:
        num_videos += 1
        ...
        with open(save_bounding_box_path + "{}_{}.pkl".format(start + 1, 120000), 'wb') as f:
