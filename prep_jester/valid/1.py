...
valid_lables_path = '/home/axp798/axp798gallinahome/Gesture-Detection/jester-v1-validation.csv'
labels_path = '/home/axp798/axp798gallinahome/Gesture-Detection/jester-v1-labels.csv'


def video_labels(valid_lables_path, labels_path):
    '''
...
def saveFramesWithLabels(video_store, json_store, val_lables_path, labels_path):
    '''
    ...
    list_val_videos_name = video_labels(val_lables_path, labels_path)
    ...
    save_video_path = '/home/axp798/axp798gallinahome/data/jester/valid_64/'
    save_bounding_box_path = "/home/axp798/axp798gallinahome/data/jester/boxes/"

    for videoName_and_label in list_val_videos_name[start: ]:
        num_videos += 1
        ...
        bounding_box_list.append(["{}".format(modified_video_name), bounding_box, label])
        ...
        with open(save_bounding_box_path + "{}_{}.pkl".format(start + 1, 15000), 'wb') as f:
    ...
    print("incorrect boxes: {}-{}".format(len(incorrect_box), incorrect_box))
    print ("Done in {}s".format(net_end_time - net_start_time))


if __name__ == '__main__':
    saveFramesWithLabels(video_store, json_store, valid_lables_path, labels_path)
